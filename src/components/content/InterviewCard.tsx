...
export default function InterviewCard({ interview, index = 0 }: InterviewCardProps) {
  return (
    ...
    >
      ...
      >
        {/* Guest header band */}
        <div className="relative bg-gradient-to-br from-zinc-800 to-zinc-950 px-6 py-5">
          {/* Topic label */}
          <span className="inline-block rounded-full border border-zinc-700/40 bg-zinc-900/70 px-3 py-1 text-[11px] font-medium uppercase tracking-widest text-zinc-400 backdrop-blur-sm">
            {interview.topic}
          </span>
        ...
        <div className="flex flex-1 flex-col p-5 pt-4">
          ...
          <div className="mt-5 flex items-center justify-between border-t border-zinc-800/60 pt-4">
            <time dateTime={interview.publishedAt} className="text-xs text-zinc-600">
